...
function main() {
  ...
  content.appendChild(title);
   ...
   other.style.cssText = "top: 50px; text-align: center; font-family: InterSemiBold; padding-top: 160px; font-size:36px; color: #333333; background-color:transparent";
  ...
  for (let i = 0; i < downloads.length; i++) 
  {
    ...
    link.style.cssText = "font-family: Inter; position: absolute; right: 5px; width: 200px; top: 50%; transform: translateY(-50%);";
