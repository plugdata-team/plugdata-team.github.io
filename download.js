function main() {
  let unstable_downloads = [
    [
      "macOS Universal",
      "https://storage.cloud.google.com/plugdata-nightly/plugdata-macOS-Universal.pkg",
      "Download",
      true,
    ],
    [
      "macOS Legacy",
      "https://storage.cloud.google.com/plugdata-nightly/plugdata-macOS-Legacy.pkg",
      "Download",
      true,
    ],
    [
      "Windows (x64)",
      "https://storage.cloud.google.com/plugdata-nightly/plugdata-Win64.msi",
      "Download",
      true,
    ],
    [
      "Windows (x86)",
      "https://storage.cloud.google.com/plugdata-nightly/plugdata-Win32.msi",
      "Download",
      true,
    ],
    [
      "Arch (x64)",
      "https://storage.cloud.google.com/plugdata-nightly/plugdata-Arch-x64.tar.gz",
      "Download",
      true,
    ],
    [
      "Debian (x64)",
      "https://storage.cloud.google.com/plugdata-nightly/plugdata-Debian-x64.tar.gz",
      "Download",
      true,
    ],
    [
      "Fedora 39 (x64)",
      "https://storage.cloud.google.com/plugdata-nightly/plugdata-Fedora-39-x64.tar.gz",
      "Download",
      true,
    ],
    [
      "Fedora 40 (x64)",
      "https://storage.cloud.google.com/plugdata-nightly/plugdata-Fedora-40-x64.tar.gz",
      "Download",
      true,
    ],
    [
      "Ubuntu 22.04 (x64)",
      "https://storage.cloud.google.com/plugdata-nightly/plugdata-Ubuntu-22.04-x64.tar.gz",
      "Download",
      true,
    ],
    [
      "Ubuntu 24.04 (x64)",
      "https://storage.cloud.google.com/plugdata-nightly/plugdata-Ubuntu-24.04-x64.tar.gz",
      "Download",
      true,
    ],
    [
      "OpenSUSE Tumbleweed (x64)",
      "https://storage.cloud.google.com/plugdata-nightly/plugdata-OpenSUSE-Tumbleweed-x64.tar.gz",
      "Download",
      true,
    ],
    [
