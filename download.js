function main() {
  let unstable_downloads = [
    [
      "macOS Universal",
      "https://glyphpress.com/plugdata/plugdata-macOS-Universal.pkg",
      "Download",
      true,
    ],
    [
      "macOS Legacy",
      "https://glyphpress.com/plugdata/plugdata-macOS-Legacy.pkg",
      "Download",
      true,
    ],
    [
      "Windows (x64)",
      "https://glyphpress.com/plugdata/plugdata-Win64.msi",
      "Download",
      true,
    ],
    [
      "Windows (x86)",
      "https://glyphpress.com/plugdata/plugdata-Win32.msi",
      "Download",
      true,
    ],
    [
      "Arch (x64)",
      "https://glyphpress.com/plugdata/plugdata-Arch-x64.tar.gz",
      "Download",
      true,
    ],
    [
      "Debian (x64)",
      "https://glyphpress.com/plugdata/plugdata-Debian-x64.tar.gz",
      "Download",
      true,
    ],
    [
      "Fedora 39 (x64)",
      "https://glyphpress.com/plugdata/plugdata-Fedora-39-x64.tar.gz",
      "Download",
      true,
    ],
    [
      "Fedora 40 (x64)",
      "https://glyphpress.com/plugdata/plugdata-Fedora-40-x64.tar.gz",
      "Download",
      true,
    ],
    [
      "Ubuntu 22.04 (x64)",
      "https://glyphpress.com/plugdata/plugdata-Ubuntu-22.04-x64.tar.gz",
      "Download",
      true,
    ],
    [
      "Ubuntu 24.04 (x64)",
      "https://glyphpress.com/plugdata/plugdata-Ubuntu-24.04-x64.tar.gz",
      "Download",
      true,
    ],
    [
      "OpenSUSE Tumbleweed (x64)",
      "https://glyphpress.com/plugdata/plugdata-OpenSUSE-Tumbleweed-x64.tar.gz",
      "Download",
      true,
    ],
    [
